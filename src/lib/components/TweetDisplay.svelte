...
<script lang="ts">
  import { parseMarkdown, formatLikes } from '$lib/utils/markdownParser.js';
  import { supabase } from '$lib/supabase.js';
  
  export let tweet;
  
  $: parsedTweet = parseMarkdown(tweet.markdown_content);
          ...
          <div class="mt-4 space-y-3">
            {#each parsedTweet.replies as reply}
              <div class="border-l-2 border-gray-200 pl-4">
                ...
                <div class="text-gray-900 text-sm mb-2 leading-relaxed">
                  {reply.body}
                </div>
